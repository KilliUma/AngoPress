...
export function useCreateCampaign() {
  ...
  return useMutation({
    ...
    onError: (e: { response?: { data?: { message?: string } }; message?: string }) =>
      toast.error(e.response?.data?.message || e.message || 'Erro ao criar campanha'),
  })
}
...
export function useSendCampaign() {
  ...
  return useMutation({
    ...
    onError: (e: { response?: { data?: { message?: string } }; message?: string }) =>
      toast.error(e.response?.data?.message || e.message || 'Erro ao enviar campanha'),
  })
}
...
export function useScheduleCampaign() {
  ...
  return useMutation({
    ...
    onError: (e: { response?: { data?: { message?: string } }; message?: string }) =>
      toast.error(e.response?.data?.message || e.message || 'Erro ao agendar campanha'),
  })
}
