...
import { pressReleasesService, PressReleaseStatus } from '../../services/press-releases.service'
import type { PressRelease } from '../../services/press-releases.service'
      ...
      {open && (
        <div className="absolute right-0 z-20 mt-1 w-44 rounded-xl border border-neutral-200 bg-white shadow-lg py-1 text-sm">
          <button
            ...
            onClick={() => {
              setOpen(false)
              navigate(`/press-releases/${pr.id}/editar`)
            }}
          >
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          type="button"
          onClick={() => navigate('/press-releases/novo')}
